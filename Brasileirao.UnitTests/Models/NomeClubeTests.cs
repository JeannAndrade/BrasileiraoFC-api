...
namespace Brasileirao.UnitTests.Models
{
    ...
    {
        [Fact]
        public void Create_criar_um_nome_de_clube_com_string_com_tamanho_valido_Sucesso()
        {
            //Arrange
        ...
        [Fact]
        public void Create_criar_um_nome_de_clube_com_string_com_tamanho_invalido_Falha()
        {
            //Arrange
        ...
        [Fact]
        public void Create_criar_um_nome_de_clube_com_string_vazia_ou_nula_DeveFalha()
        {
            //Arrange
